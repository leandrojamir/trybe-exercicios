...
# localhost 8085, onde telnet é a aplicação que vamos utilizar, localhost é o
# local onde o servidor está (no caso, o seu próprio PC) e 8085 é a porta
# em que o servidor está escutando conexões.
