...
# setores de vendas, financeiro e suporte. Para respeitar a nova
# Lei Geral de Proteção de Dados, a empresa precisa garantir que as
...
# De olho na dica: esse problema lembra o de combos na hamburgueria, que você
# já conhece! Aqui precisamos de uma implementação semelhante,
# utilizando o padrão Factory.

# De olho na dica: a Account pode ser sua Interface Criadora, que será herdada
# pelas fábricas, que podem ser classes referentes aos perfis de acessos.
