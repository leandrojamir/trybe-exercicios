...
# score para receber essa estrutura e fazer a consulta de se aquele score já
# foi calculado antes. Mas essa estrutura auxiliar é parte do cálculo dos
# scores e não faz sentido que ela fique solta na main. Então vamos envelopar
