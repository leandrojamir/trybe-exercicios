...
# a estrutura subordinates; a própria classe vai cuidar de montar essa
# estrutura enquanto adiciona as pessoas.

#  Vamos definir um exemplo para pensar: Se eu quiser adicionar a pessoa 8 na
# equipe de 4, com k=2?

#  A equipe de 4 está cheia, então eu preciso tentar encaixar na equipe de
# algum subordinado a 4, ou seja, na equipe de 5 ou de 6. É super importante
# observar que eu posso incluir 8 em qualquer lugar abaixo 4. Isso significa
# que eu sempre vou conseguir incluir a pessoa, pois no final da cadeia,
# haverá uma pessoa sem equipe e eu posso atribuir a nova contratada para ela.
# Ou seja, ao invés de tentar olhar em “largura” e tentar incluir em 5 e
# depois em 6, eu posso ir descendo na cadeia até achar um lugar que ela caiba,
# olhando em “profundidade”: olho 4, depois 5, se 5 estivesse cheio, olho a 7.
